...
public class ImpmonParser extends Parser {
	...
	public static class DefvarsContext extends ParserRuleContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof ImpmonVisitor ) return ((ImpmonVisitor<? extends T>)visitor).visitDefvars(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class DefconstContext extends ParserRuleContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof ImpmonVisitor ) return ((ImpmonVisitor<? extends T>)visitor).visitDefconst(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class DefstructContext extends ParserRuleContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof ImpmonVisitor ) return ((ImpmonVisitor<? extends T>)visitor).visitDefstruct(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class DefunionContext extends ParserRuleContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof ImpmonVisitor ) return ((ImpmonVisitor<? extends T>)visitor).visitDefunion(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class TypedefContext extends ParserRuleContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof ImpmonVisitor ) return ((ImpmonVisitor<? extends T>)visitor).visitTypedef(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class PassStmtContext extends StmtContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof ImpmonVisitor ) return ((ImpmonVisitor<? extends T>)visitor).visitPassStmt(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class Dowhile_stmtContext extends ParserRuleContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof ImpmonVisitor ) return ((ImpmonVisitor<? extends T>)visitor).visitDowhile_stmt(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class CharContext extends TermContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof ImpmonVisitor ) return ((ImpmonVisitor<? extends T>)visitor).visitChar(this);
			else return visitor.visitChildren(this);
		}
	}
